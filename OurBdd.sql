...
CREATE TABLE glpi_locations (
  id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  entities_id NUMBER DEFAULT NULL,
  name VARCHAR2(255),
...
-- Sur les tables PARTITIONNEES (equipments, computers, printers, tickets)
...
CREATE UNIQUE INDEX uk_loc_ent_loc_name   ON glpi_locations     (entities_id,  name) TABLESPACE TS_GLPI_INDX;
